...
public class BitcoinAddressManagerBean implements UTXOAddressManager {
  ...
  static {
    networkParamsUTXOProviderMap.put(NetworkParams.MAINNET, new MainNetParams());
    networkParamsUTXOProviderMap.put(NetworkParams.TESTNET, new TestNet3Params());
    networkParamsUTXOProviderMap.put(NetworkParams.LOCAL, new RegTestParams());
  }
